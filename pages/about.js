                        ...
                        <div className="aboutSection">
                            <div className="aboutText">
                                <Card.Text>
                                    ...
                                    <h3 className="aboutText">I have a background in the medical field where I was going to school to be a nurse until a knee injury prevented me from continuing that career path.</h3>
