                ...
                <Card style={{ width: '100%', background: 'rgba(255, 255, 255, 0.5)' }}>
                    <Card.Body>
                        ...
                        <Card.Text>
                            ...
                            <h3 className="aboutText">I have a background in the medical field where I was going to school to be a nurse until an injury made it impossible to continue.</h3>
                            <h3 className="aboutText">More recently, I was a quality assurance technician at an aerospace manufaturing company.</h3>
